...
import { Button, MenuItem, Box, Stack, TextField } from "@mui/material";
...
const UploadForm=({genres, contentRatings, onClose, fetchVideos})=>{
    ...
    const handleSubmit=async()=>{
        ...
        try{
            const req=await axios.post(endpoint, postData);
            console.log(req.data);
            if(req.status===201){
                console.log("POST Request made with", postData);
                enqueueSnackbar("Video Upload Successfully", { variant: "success" });
